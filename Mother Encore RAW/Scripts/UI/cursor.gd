...
func _physics_process(delta):
	if is_active():
		input = Vector2.ZERO
		if Input.is_action_just_pressed("ui_left") or Input.is_action_just_pressed("ui_dpad_left") or Input.is_action_just_pressed("ui_lstick_left") or Input.is_action_just_pressed("ui_rstick_left") or Input.is_action_just_pressed("ui_key_left"):
			input.x -= 1
		if Input.is_action_just_pressed("ui_right") or Input.is_action_just_pressed("ui_dpad_right") or Input.is_action_just_pressed("ui_lstick_right") or Input.is_action_just_pressed("ui_rstick_left") or Input.is_action_just_pressed("ui_key_right"):
			input.x += 1
		if Input.is_action_just_pressed("ui_up") or Input.is_action_just_pressed("ui_dpad_up") or Input.is_action_just_pressed("ui_lstick_up") or Input.is_action_just_pressed("ui_rstick_up") or Input.is_action_just_pressed("ui_key_up"):
			input.y -= 1
		if Input.is_action_just_pressed("ui_down") or Input.is_action_just_pressed("ui_dpad_down") or Input.is_action_just_pressed("ui_lstick_down") or Input.is_action_just_pressed("ui_rstick_down") or Input.is_action_just_pressed("ui_key_down"):
			input.y += 1
