...
var textSpeed = 0.08
var text = [
<<<<<<< HEAD:Scripts/Cutscenes/Mt Itoi Landscape.gd
	"Es el año 1988.",
=======
	"Es el año 1988.", 
>>>>>>> parent of 0854d9c (Traducción desde los archivos originales):Translation/Scripts/Cutscenes/Mt Itoi Landscape.gd
